              ...
              >
                ...
                <div className="flex justify-center gap-4">
                  {[1, 2, 3, 4, 5, 6, 7].map((value) => (
                    <label
                      key={value}
                      className="text-sm leading-9 font-normal text-[#20252c] align-top cursor-pointer flex flex-col items-center gap-2 relative flex-1 max-w-[100px]"
                    >
                      <input
                        type="radio"
                        name={`fss-${index}`}
                  ...
                  {uwesOptions.map((option, optIndex) => (
                    ...
                    >
                      <input
                        ...
                        onChange={() =>
                          setUwesAnswers({ ...uwesAnswers, [index]: optIndex })
                        }
                        className="my-[10px] mx-1.5 w-4 h-4 accent-[#0f6cbd] cursor-pointer"
                      />
